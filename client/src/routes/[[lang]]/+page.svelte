...
<div class="prompt-container">
    <div class="left-column">
      <div class="chat-box small-prompt">
        <textarea id="job_url" placeholder={$_('job_url_placeholder')} bind:value={jobUrl}></textarea>
      </div>

      <div class="chat-box">
        <textarea id="prompt" bind:value={userPrompt}></textarea>
      </div>
    </div>
    ...
    <div class="right-column">
      <div class="chat-box large-prompt">
        <div>
          <textarea id="generated_resume" placeholder={$_('generated_resume_placeholder')} class="large-textarea" bind:value={generatedResume} readOnly></textarea>
          <div class="actions">
            <span class="status-message">{statusMessage}</span>
            <button type="button" class="black-btn" on:click={generateResume} disabled={isLoading}>
              {#if isLoading}
                <span class="spinner"></span>
              {:else}
                <span class="button-text">{$_('generate_button')}</span>
              {/if}
            </button>
          </div>
        </div>
